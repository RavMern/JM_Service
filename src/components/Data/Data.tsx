        ...
        <section className="py-20 text-white">
            <div className="relative mx-auto px-4 max-w-6xl">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="-right-20 -bottom-40 z-0 absolute border-[10px] border-cta/70 w-32 md:w-44 h-56"></motion.div>
                <motion.div
                    initial={{ translateX: 200, opacity: 0 }}
                    whileInView={{ translateX: 0, opacity: 1 }}
                    transition={{ duration: 1.5, }}
                    viewport={{ once: true }}
                    className="-top-60 -left-13 z-0 absolute border-[10px] border-cta/70 w-32 md:w-44 h-56"></motion.div>
